...
class Logger:
    ...
    def init_logging_writer(self) -> None:
        """Initialize the logging writer, which can be either Tensorboard or W&B and save the code state.

        If the writer is W&B, the configuration and code state are uploaded as well.
        """
